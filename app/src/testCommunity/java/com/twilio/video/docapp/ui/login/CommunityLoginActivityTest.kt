...
import com.twilio.video.docapp.DaggerCommunityIntegrationTestComponent
import com.twilio.video.docapp.R
import com.twilio.video.docapp.TestApp
import com.twilio.video.docapp.android.SharedPreferencesWrapper
import com.twilio.video.docapp.auth.CommunityAuthModule
import com.twilio.video.docapp.auth.CommunityAuthenticator
import com.twilio.video.docapp.data.AuthServiceModule
import com.twilio.video.docapp.data.PASSCODE
import com.twilio.video.docapp.data.Preferences.DISPLAY_NAME
import com.twilio.video.docapp.data.api.AuthService
import com.twilio.video.docapp.data.api.AuthServiceRepository
import com.twilio.video.docapp.data.api.AuthServiceRequestDTO
import com.twilio.video.docapp.data.api.AuthServiceResponseDTO
import com.twilio.video.docapp.data.api.URL_PREFIX
import com.twilio.video.docapp.data.api.URL_SUFFIX
import com.twilio.video.docapp.screen.assertErrorDialogIsDisplayed
import com.twilio.video.docapp.screen.assertExpiredPasscodeErrorIsDisplayed
import com.twilio.video.docapp.screen.assertInvalidPasscodeErrorIsDisplayed
import com.twilio.video.docapp.screen.assertLoadingIndicatorIsDisplayed
import com.twilio.video.docapp.screen.assertLoadingIndicatorIsNotDisplayed
import com.twilio.video.docapp.screen.assertLoginButtonIsDisabled
import com.twilio.video.docapp.screen.assertLoginButtonIsEnabled
import com.twilio.video.docapp.screen.assertThatPasscodeErrorIsDisabled
import com.twilio.video.docapp.screen.clickLoginButton
import com.twilio.video.docapp.screen.enterYourName
import com.twilio.video.docapp.security.SecurePreferencesFake
import com.twilio.video.docapp.security.SecurityModule
import com.twilio.video.docapp.ui.room.RoomActivity
import com.twilio.video.docapp.util.EXPIRED_PASSCODE_ERROR
import com.twilio.video.docapp.util.INVALID_PASSCODE_ERROR
import com.twilio.video.docapp.util.MainCoroutineScopeRule
import com.twilio.video.docapp.util.getMockHttpException
import com.twilio.video.docapp.util.getSharedPreferences
